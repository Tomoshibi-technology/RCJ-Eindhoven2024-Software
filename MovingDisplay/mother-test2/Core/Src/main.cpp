...
int main(void)
{
  ...
  if (!bno055.begin()) {
	  // „Çª„É≥„ÇµÂàùÊúüÂåñÂ§±ÊïóÊôÇ„ÅÆÂá¶Áê?
...
//ÁßªÂãï‰ΩçÁΩÆ->ÁßªÂãï„Çπ„ÉîÔøΩ???øΩ?øΩ??øΩ?øΩ?
...
//ÁßªÂãï„Çπ„ÉîÔøΩ???øΩ?øΩ??øΩ?øΩ?->??øΩ?øΩ?„É¢„Éº„Çø„Éº„ÅÆ„Çπ„ÉîÔøΩ???øΩ?øΩ??øΩ?øΩ?
	speed_set(rotate, speed, degree, MTRS, 0.7);

//??øΩ?øΩ?„É¢„Éº„Çø„Éº„ÅÆ„Çπ„ÉîÔøΩ???øΩ?øΩ??øΩ?øΩ?->ÈÄÅ„ÇãË°åÔøΩ??
	set_array(MTRS, send_array);

////„É¢„Éº„Çø„Éº„Å´ÈÄÅ„Çã
	if(HAL_GPIO_ReadPin(STRTSW_GPIO_Port, STRTSW_Pin) == 1){
	  HAL_UART_Transmit(&huart6, send_array, 12, 1);
	}else{//„Çπ„Çø„Éº„Éà„Çπ„Ç§??øΩ?øΩ?„ÉÅ„Åå„Ç™„ÉïÔøΩ???øΩ?øΩ??øΩ?øΩ?
		for(int i=0; i<4; i++){
